...
For example, an enum member `No` on an arbitrary variable like this `mybox.No`,
could refer to `QtWidgets.QDialogButtonBox.StandardButton.No`
...
A complete list of member name clashes is given in [conflicts.md](conflicts.md).
...
For the versions available, see the [tags on this repository](https://github.com/AWhetter/PySide6-subsitutions/tags).
